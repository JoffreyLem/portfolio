...
import { skillCategoriesWithIcons } from '@/constants/data'
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Expertise technique centrée sur le backend, les architectures
            distribuées et la gestion de systèmes en production
          </p>
        </motion.div>
